...
app["delete"]("/api/delete-user", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _id, deltedUser, users_2, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 2:
                users_2 = _a.sent();
                res.send({ ok: true, users: users_2 });
                return [3 /*break*/, 4];
            case 3:
                error_3 = _a.sent();
...
//update
//update name
app.put("/api/update-user", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _id, newName, updateUserName, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, UserModel.updateOne({ _id: _id }, { name: newName })];
            case 1:
