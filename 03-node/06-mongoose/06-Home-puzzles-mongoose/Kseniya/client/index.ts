...
const handleUpdateName = (user: User) => {
  const updateUser = document.getElementById("userCard")
  console.log(updateUser)
  if (updateUser) updateUser.innerHTML += `<div class="updateForm">
