...
exports.addUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, password, email, userDB, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, usersModel_1["default"].create({ name: name, password: password, email: email })];
            case 1:
                userDB = _b.sent();
                console.log(userDB);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                userDB = _b.sent();
                if (!userDB)
                    throw new Error("Please Cheack Username or password");
                if (!secret)
                    throw new Error("Missing jwt secret");
                token = jwt_simple_1["default"].encode({ userId: userDB._id, role: "public" }, secret);
                console.log(token);
                res.cookie("user", token, { httpOnly: true });
                res.status(201).send({ userDB: userDB });
                return [3 /*break*/, 3];
            case 2:
                error_3 = _b.sent();
