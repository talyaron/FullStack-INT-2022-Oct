...
exports.getUserFromCokkie = exports.logIn = exports.addUser = void 0;
...
exports.addUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, password, role, error_1;
...
exports.logIn = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, password, user, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
            ...
            case 1:
                ...
                if (!user) {
                    ...
                    token = jwt_simple_1["default"].encode(user._id, secret);
...
exports.getUserFromCokkie = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, decoded, user, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userModel_1["default"].findById(decoded)];
            case 1:
                user = _a.sent();
                if (!user)
