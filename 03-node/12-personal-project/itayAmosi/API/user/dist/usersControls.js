...
exports.addUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, phoneNumber, userDB, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name = _a.name, email = _a.email, password = _a.password, phoneNumber = _a.phoneNumber;
                return [4 /*yield*/, usersModel_1["default"].create({ name: name, email: email, password: password, phoneNumber: phoneNumber })];
            case 1:
                userDB = _b.sent();
                res.status(201).send({ ok: true, userDB: userDB });
                return [3 /*break*/, 3];
