...
function handelTeacher() {
  try {
    fetch("/API/teachers/get-teachers").then(function (res) {
      return res.json();
    }).then(function (_a) {
      ...
      try {
        ...
        teachers.forEach(function (teacher) {
          getTeacherCourses(teacher.courses).then(function (_a) {
            var courses = _a.courses;
            renderTeacherTable(__assign(__assign({}, teacher), {
              courses: courses
            }));
          });
        });
...
function getTeacherCourses(ids) {
