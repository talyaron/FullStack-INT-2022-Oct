...
exports.addExam = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, studentId, studentDB, examDB, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, examsModel_1["default"].create({ name: name, student: studentDB })];
            case 2:
                examDB = _b.sent();
