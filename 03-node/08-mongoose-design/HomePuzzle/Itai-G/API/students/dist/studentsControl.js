...
exports.addStudent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, gradeId, gradeDB, studentDB, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body, name = _a.name, gradeId = _a.gradeId;
                return [4 /*yield*/, gradesModel_1["default"].findById(gradeId)];
            case 1:
                gradeDB = _b.sent();
                if (!gradeDB) {
                    throw new Error("gradeDB is missing from request body");
                }
                return [4 /*yield*/, studentModel_1["default"].create({ name: name, grade: gradeDB })];
            case 2:
                studentDB = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, studentModel_1["default"].findById(_id)];
            case 1:
                student = _b.sent();
                if (!student) {
                    throw new Error("No student found with _id: " + _id);
                }
                return [4 /*yield*/, studentModel_1["default"].updateOne({ _id: _id }, { name: updatedName })];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, studentModel_1["default"].deleteOne({ _id: _id })];
            case 1:
