...
exports.addGrade = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, courseName, teacherName, couresName, score, date, gradeDB, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, courseName = _a.courseName, teacherName = _a.teacherName, couresName = _a.couresName, score = _a.score, date = _a.date;
                return [4 /*yield*/, gradesModel_1["default"].create({ courseName: courseName, teacherName: teacherName, couresName: couresName, score: score, date: date })];
            case 1:
                gradeDB = _b.sent();
                console.log(gradeDB);
