...
exports.addUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, fname, phone, email, userDB, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name = _a.name, fname = _a.fname, phone = _a.phone, email = _a.email;
                return [4 /*yield*/, usersModel_1["default"].create({ name: name, fname: fname, phone: phone, email: email })];
            case 1:
                userDB = _b.sent();
