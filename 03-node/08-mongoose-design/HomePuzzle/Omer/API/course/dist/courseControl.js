...
exports.deleteCourse = exports.getCourses = exports.addCourse = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                name = req.body;
                return [4 /*yield*/, courseModel_1["default"].create(name)];
            case 1:
                course = _a.sent();
                console.log(course);
...
exports.deleteCourse = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var courseId_1, students, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                courseId_1 = req.body.courseId;
                return [4 /*yield*/, studentModel_1["default"].find({})];
            case 1:
                students = _a.sent();
                students.forEach(function (student) { return __awaiter(void 0, void 0, void 0, function () {
                    var courses, index;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                return [4 /*yield*/, courseModel_1["default"].findByIdAndDelete(courseId_1)];
            case 2:
                _a.sent();
