    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!_id)
                    throw new Error("no id in date");
                return [4 /*yield*/, studentModel_1["default"].findOneAndUpdate({ _id: _id }, { name: name })];
            case 1:
                student = _b.sent();
                if (!student)
                    throw new Error("no student in date");
                res.send({ ok: true });
                return [3 /*break*/, 3];
            case 2:
                error_3 = _b.sent();
