...
exports.userFromcookies = exports.logIn = exports.addUser = void 0;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                token = jwt_simple_1["default"].encode(user._id, secretToken);
...
exports.userFromcookies = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _id, user, error_3;
