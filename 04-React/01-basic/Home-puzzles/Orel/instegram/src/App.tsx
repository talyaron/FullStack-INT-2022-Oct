  ...
  return (
    <section>
      ...
      <div className='container-users-story'>
        {posts.map(post => <StoryUsers authorName={post.authorName} image={post.image} />)}  </div>
      {/* Posts */}
      <div className='container-posts'>
        {posts.map(post => <Post title={post.title} authorName={post.authorName} text={post.text} image={post.image} />)}</div>
    </section>
  )
}
