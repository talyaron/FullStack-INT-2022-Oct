...
users.push(
    new User(
      "dad",
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4HqB6YPJCVPEwBJwQYjidklQcWa507EQqtA&usqp=CAU"
    )
  );
  users.push(
    new User(
  ...
  users.push(
    new User(
      "son",
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDim2kq_9yyl5gxJEgCiqPV1Zh0OEUvmz07w&usqp=CAU"
    )
  );
