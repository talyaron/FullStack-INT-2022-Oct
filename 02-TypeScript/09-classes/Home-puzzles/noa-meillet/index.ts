...
class Celebs{
    ...
    constructor(name: string, genre: string, accountInTiktok: string, accountInInstagram: string, numberOfFollower: number,){
        name= this.name ;
        genre= this.genre ;
...
const shlomiShabat = new Celebs("hlomi Shabat","singer","shlomi123","shlomi123",200);
