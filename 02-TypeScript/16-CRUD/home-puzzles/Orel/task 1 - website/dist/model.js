var Movies = /** @class */ (function () {
    function Movies(url, name, des, stars, releaseDate) {
        this.url = url;
        this.name = name;
        this.des = des;
        this.stars = stars;
...
var movies = [
    ...
    {
        url: "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/d9nBoowhjiiYc4FBNtQkPY7c11H.jpg",
        name: "M3GAN  ",
        des: " 'A brilliant toy company roboticist uses artificial intelligence to develop M3GAN, works too well,",
        stars: 4,
        releaseDate: 2023
    },
];
