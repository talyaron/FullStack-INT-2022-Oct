...
input.addEventListener("keypress", (event:KeyboardEvent|undefined):void => {
  let addNum= document.querySelector(".Some_numbers_have_been_entered")as HTMLHeadElement;
  let error_Only_3_numbers = document.querySelector(".Only_3_numbers")as HTMLHeadElement ;
  let btn = document.querySelector("#btn")as HTMLButtonElement;
  let enter3num = document.querySelector(".The_amount_of_numbers_entered")as HTMLDivElement ;
...
let btnEncryption=document.querySelector(".btnEncryption" )as HTMLButtonElement;


 btnEncryption.addEventListener('click', (event) => {
    let encryptionResult : string ="";
  let inputEncryption  = (document.querySelector(".inputEncryption")as HTMLInputElement|null)?.value;
