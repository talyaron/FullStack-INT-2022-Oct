...
let count:number = Number(score)
let score2 =document.querySelector("#scorePl2")!.textContent
let count2:number = Number(score2)
...
let playerName1 = document.querySelector("#input1")! as HTMLInputElement
let playerName2 = document.querySelector("#input2")! as HTMLInputElement
