...
btn.addEventListener("click", function (e) {
    ...
    if (inputName) {
        if (testnumber_2 === false && testnumber === false && testnumber_1 === true) {
    ...
    if (inputPassword.length < 5 && inputPassword.length > 20) {
        errorPassword.innerHTML = "** The password must be between 5 and 20 characters";
    }
    var regularExpressionName_3 = /[A-Z]+/;
    var testnumber_3 = regularExpressionName_3.test(inputPassword);
    if (testnumber_3 === false && inputPassword.length > 5 && inputPassword.length < 20) {
    ...
    if (testnumber_4 === true && inputPassword.length > 5 && inputPassword.length < 20 && testnumber_3 === true) {
        errorPassword.innerHTML = "** Password cannot contain the space character";
    }
    // ------------------------------------------------
    var inputEmail = document.querySelector(".input_emaul").value;
    ...
    if (testnumber === false && testnumber_1 === true && testnumber_2 === true && inputPassword.length > 5 && inputPassword.length < 20 && testnumber_3 === true && testnumber_4 === false && testnumber_5 === true) {
