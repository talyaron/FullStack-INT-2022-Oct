...
(_b = document.getElementById("highScore")) === null || _b === void 0 ? void 0 : _b.innerHTML = "your high score is " + hiScore;
...
var drink_3 = new coctail("cosmopolitan", [bi_vodka, bi_cranberry, bi_lime, bi_ice, bi_tripleSec]);
var drink_4 = new coctail("Negroni", [bi_gin, bi_campari, bi_vermouth]);
var drink_5 = new coctail('Manhattan', [bi_whiskey, bi_vermouth, bi_Angostura, bi_ice]);
var drink_6 = new coctail('Old Fashioned', [bi_whiskey, bi_Angostura, bi_sugar,]);
...
var drink_9 = new coctail('French 75', [bi_gin, bi_syrup, bi_lemon, bi_champagne]);
...
var drink_16 = new coctail('all', [bi_tequila, bi_rum, bi_champagne, bi_brandy]);
...
function selectCocktail() {
    ...
    $("#hint").fadeOut(5000);
    (_b = document.getElementById("customerDialog")) === null || _b === void 0 ? void 0 : _b.innerHTML = 'hello please give me  ' + selectedDrink.name;
    while (((_c = document.getElementById("shaker")) === null || _c === void 0 ? void 0 : _c.children.length) > 0) {
        ...
        document.getElementById(targetShelf).append(((_f = document.getElementById("shaker")) === null || _f === void 0 ? void 0 : _f.children[0]));
    }
}
selectCocktail();
function serve() {
    ...
    if ((shakerContent === null || shakerContent === void 0 ? void 0 : shakerContent.length) != selectedDrink.ingredients.length) {
        //loose
        (_b = document.getElementById("customerDialog")) === null || _b === void 0 ? void 0 : _b.innerHTML = 'wft is this abomination , taste like shit';
        console.log("lose1");
        points = points - 10;
    }
    else {
        try {
            ...
            if (drinkTaste == true) {
                //win
                (_c = document.getElementById("customerDialog")) === null || _c === void 0 ? void 0 : _c.innerHTML = 'thank you, that was very tasty';
                points = points + 5;
                console.log("win");
            }
            else {
                //loose
                (_d = document.getElementById("customerDialog")) === null || _d === void 0 ? void 0 : _d.innerHTML = "give this cocktail to your manger";
                console.log("lose2");
                points = points - 10;
            }
        }
    ...
    if (points < 1) {
        (_g = document.getElementById("customerDialog")) === null || _g === void 0 ? void 0 : _g.innerHTML = "YOU ARE FIRED , go home and learn some js";
    }
    else {
