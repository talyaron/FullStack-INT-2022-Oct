...
const questionsContainer = document.querySelector("#questionContainer") as HTMLDivElement
const questionElement:any = document.querySelector("#question")
const answerButtonsElements = document.querySelectorAll("#answerButtons")
const endGameAlert = document.querySelector("#endGameAlert") as HTMLDivElement
const quizContainer = document.querySelector(".container") as HTMLDivElement
const endGameMessage = document.querySelector("#endGameMessage") as HTMLHeadingElement
const finalScore = document.querySelector("#finalScore") as HTMLHeadingElement
...
function resetState(){
    while (answerButtonsElements[0].firstChild) {
        answerButtonsElements[0].removeChild
        (answerButtonsElements[0].firstChild)
    }
}  
